...
import 'package:eyepetizer/page/mine/MinePage.dart';
...
class _TabNavigationState extends State<TabNavigation> {
  ...
  List<BottomNavigationBarItem> _item() {
    return [
      _bottomItem(MyStrings.home, 'images/ic_home_normal.png',
          'images/ic_home_selected.png'),
      _bottomItem(MyStrings.discovery, 'images/ic_discovery_normal.png',
          'images/ic_discovery_selected.png'),
      _bottomItem(MyStrings.hot, 'images/ic_hot_normal.png',
          'images/ic_hot_selected.png'),
      _bottomItem(MyStrings.mine, 'images/ic_mine_normal.png',
  ...
  Future<bool> _onWillPop() async {
    if (lastTime == null ||
      ...
      LeoToast.showTip(MyStrings.exit_tip);
      return false;
    } else {
      // 自动出栈
      return true;
